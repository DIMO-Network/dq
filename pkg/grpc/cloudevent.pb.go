...
type CloudEvent struct {
	...
	// data is the decoded payload (e.g. JSON). Empty when the payload is binary and
	// carried in data_base64 instead.
	Data []byte `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
	// data_base64 is the base64-encoded payload, set instead of data when the
	// payload is binary (≤ the inline threshold; larger ones are externalized).
	// Exactly one of data / data_base64 is populated, mirroring the CloudEvent model.
...
const file_pkg_grpc_cloudevent_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\fR\x05value:\x028\x01B%Z#github.com/DIMO-Network/dq/pkg/grpcb\x06proto3"
