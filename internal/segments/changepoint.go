...
// NewChangePointDetector creates a new ChangePointDetector with the given source.
func NewChangePointDetector(src SignalSource) *ChangePointDetector {
	return &ChangePointDetector{src: src}
}
...
func (d *ChangePointDetector) DetectSegments(
	...
	windows, err := d.src.WindowedSignalCounts(ctx, subject, lookbackFrom, to, defaultCUSUMWindowSeconds, defaultCUSUMSignalCountThreshold, defaultCUSUMDistinctSignalCountThreshold)
	if err != nil {
