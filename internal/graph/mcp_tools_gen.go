...
var MCPTools = []mcpserver.ToolDefinition{
	...
	},
	{
		...
		Query: "query($subject: String!, $filter: CloudEventFilter, $includeDeleted: Boolean) { latestCloudEvent(subject: $subject, filter: $filter, includeDeleted: $includeDeleted) { header { type source subject id time producer } data dataUrl } }",
		Annotations: &mcp.ToolAnnotations{
			ReadOnlyHint:    true,
			DestructiveHint: boolPtr(false),
			OpenWorldHint:   boolPtr(false),
	...
	},
	{
		...
		Query: "query($subject: String!, $limit: Int, $filter: CloudEventFilter, $includeDeleted: Boolean) { cloudEvents(subject: $subject, limit: $limit, filter: $filter, includeDeleted: $includeDeleted) { header { type source subject id time producer } data dataUrl } }",
		Annotations: &mcp.ToolAnnotations{
			ReadOnlyHint:    true,
			DestructiveHint: boolPtr(false),
			OpenWorldHint:   boolPtr(false),
	...
	},
	{
		...
		Query: "query($subject: String!, $filter: CloudEventFilter, $includeDeleted: Boolean) { availableCloudEventTypes(subject: $subject, filter: $filter, includeDeleted: $includeDeleted) { type count firstSeen lastSeen } }",
		Annotations: &mcp.ToolAnnotations{
			ReadOnlyHint:    true,
			DestructiveHint: boolPtr(false),
			OpenWorldHint:   boolPtr(false),
